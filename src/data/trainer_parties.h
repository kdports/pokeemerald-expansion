...
static const struct TrainerMonItemCustomMoves sParty_GruntRusturfTunnel[] = { // Overwritten, hard Caroline
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_WILL_O_WISP, MOVE_HEX, MOVE_CURSE, MOVE_FIRE_BLAST},
	.abilityNums = 0,
    },
    {
    .iv = 10,
    ...
    .moves = {MOVE_BATON_PASS, MOVE_ICY_WIND, MOVE_CALM_MIND, MOVE_OMINOUS_WIND},
	.abilityNums = 0,
    },
    {
    .iv = 10,
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_MAGICAL_LEAF, MOVE_SWIFT, MOVE_SHADOW_BALL, MOVE_TAUNT},
	.abilityNums = 0,
    },
    {
    .iv = 10,
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_THUNDER_WAVE, MOVE_THIEF, MOVE_SWORDS_DANCE},
	.abilityNums = 0,
    },
    {
    .iv = 10,
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_MEAN_LOOK, MOVE_HYPNOSIS, MOVE_SUCKER_PUNCH, MOVE_SHADOW_PUNCH},
	.abilityNums = 0,
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_GruntMtPyre2[] = { // Overwritten, hard real Brandon
	...
	.heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_FISHIOUS_REND, MOVE_PSYCHIC_FANGS, MOVE_CRUNCH, MOVE_DRAGON_RUSH},
	.abilityNums = 0,
    },
    {
    .iv = 100,
    ...
    .moves = {MOVE_IRON_HEAD, MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_STONE_EDGE},
	.abilityNums = 0,
    },
    {
    .iv = 100,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_OUTRAGE, MOVE_IRON_HEAD, MOVE_ROOST},
	.abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_PROTECT, MOVE_METEOR_MASH, MOVE_CLOSE_COMBAT},
	.abilityNums = 1,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Zander[] = {  // Overwritten, E4 fight one (Caroline + Brandon)
    ...
    .moves = {MOVE_DISARMING_VOICE, MOVE_WATER_PULSE, MOVE_HYPER_VOICE, MOVE_FLAMETHROWER},
	.abilityNums = 1,
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_ShellyWeatherInstitute[] = {  // Overwritten, E4 fight two (Noah + Nick)
	...
	.heldItem = ITEM_FLAME_ORB,
	.moves = {MOVE_THUNDER_PUNCH, MOVE_KNOCK_OFF, MOVE_CLOSE_COMBAT, MOVE_ICE_PUNCH},
	.abilityNums = 0,
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_ShellySeafloorCavern[] = {  // Overwritten, E4 fight three (Matthew + Avaani)
    {
    .iv = 100,
    .lvl = 66,
    .species = SPECIES_BRAVIARY,
	.heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_TAILWIND, MOVE_BODY_SLAM, MOVE_IRON_HEAD, MOVE_ROCK_SLIDE},
	.abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .species = SPECIES_MARSHADOW,
	.heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SUCKER_PUNCH, MOVE_JUMP_KICK, MOVE_ICE_PUNCH},
	.abilityNums = 0,
    },
    {
    .iv = 100,
	...
	.heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_SOFT_BOILED, MOVE_TOXIC, MOVE_HEAL_PULSE},
	.abilityNums = 1,
    },
    {
    .iv = 100,
	...
	.heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_CRUNCH, MOVE_IRON_TAIL, MOVE_PROTECT},
	.abilityNums = 1,
    },
    {
    .iv = 100,
	...
	.heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HELPING_HAND, MOVE_FLARE_BLITZ, MOVE_RETALIATE, MOVE_AERIAL_ACE},
	.abilityNums = 0,
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Archie[] = {  // Overwritten, E4 fight four (Natasha + Belinda)
    {
    .iv = 100,
    .lvl = 67,
    .species = SPECIES_DRAMPA,
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_DRAGON_PULSE, MOVE_HYPER_VOICE, MOVE_FIRE_BLAST, MOVE_THUNDERBOLT},
	.abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .heldItem = ITEM_FLAME_ORB,
    .moves = {MOVE_AERIAL_ACE, MOVE_SWORDS_DANCE, MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE},
	.abilityNums = 0,
    },
    {
    .iv = 100,
    ...
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_HELPING_HAND, MOVE_FIRE_FANG, MOVE_RETALIATE, MOVE_WORK_UP},
	.abilityNums = 1,
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Leah[] = {  // Overwritten, E4 fight one easy
    ...
    .species = SPECIES_LUCARIO,
	.heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_PROTECT, MOVE_DIG, MOVE_BRICK_BREAK},
	.abilityNums = 1,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daisy[] = {  // Overwritten, E4 fight two easy
    ...
    .species = SPECIES_MACHAMP,
	.heldItem = ITEM_SITRUS_BERRY,
	.moves = {MOVE_THUNDER_PUNCH, MOVE_KNOCK_OFF, MOVE_REVENGE, MOVE_ICE_PUNCH},
	.abilityNums = 0,
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Rose1[] = {  // Overwritten, E4 fight three easy
    {
    .iv = 100,
    .lvl = 66,
    .species = SPECIES_BLISSEY,
    ...
    .species = SPECIES_SHARPEDO,
	.heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_TOMB, MOVE_AQUA_JET, MOVE_CRUNCH, MOVE_RAIN_DANCE},
	.abilityNums = 1,
    }
};

static const struct TrainerMonItemCustomMoves sParty_Felix[] = {  // Overwritten, E4 fight four easy
    {
    .iv = 100,
    .lvl = 67,
    .species = SPECIES_URSARING,
    ...
    .species = SPECIES_STOUTLAND,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HELPING_HAND, MOVE_CRUNCH, MOVE_RETALIATE, MOVE_WORK_UP},
	.abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .species = SPECIES_HYDREIGON,
	.heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CRUNCH, MOVE_DRAGON_PULSE, MOVE_PROTECT, MOVE_HYPER_BEAM},
	.abilityNums = 0,
    }
};

static const struct TrainerMonItemCustomMoves sParty_Violet[] = { // Overwritten, Champion easy
    {
    .iv = 55,
    .lvl = 69,
    .species = SPECIES_GENGAR,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_NASTY_PLOT, MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB, MOVE_THUNDERBOLT},
	.abilityNums = 1,
    },
    {
    .iv = 55,
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_PSYCHO_CUT, MOVE_SWORDS_DANCE, MOVE_ICE_PUNCH},
	.abilityNums = 1,
    },
    {
    .iv = 55,
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_EXTRASENSORY},
	.abilityNums = 1,
    },
    {
    .iv = 55,
	...
	.heldItem = ITEM_NONE,
    .moves = {MOVE_BRAVE_BIRD, MOVE_FLARE_BLITZ, MOVE_TAILWIND, MOVE_ROOST},
	.abilityNums = 2,
    },
    {
    .iv = 55,
    ...
    .species = SPECIES_STEELIX,
	.heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_TAIL, MOVE_EARTHQUAKE, MOVE_THUNDER_FANG, MOVE_PROTECT},
	.abilityNums = 1,
    }
};

static const struct TrainerMonItemCustomMoves sParty_Rose2[] = { // Overwritten, Champion hard
    {
    .iv = 255,
    .lvl = 69,
    .species = SPECIES_GENGAR,
...
static const struct TrainerMonItemCustomMoves sParty_Rose5[] = {
    {
    .iv = 40,
    .lvl = 34,
    .species = SPECIES_BRELOOM,
