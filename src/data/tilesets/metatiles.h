...
const u16 gMetatiles_GhostHouse[] = INCBIN_U16("data/tilesets/secondary/ghost_house/metatiles.bin");
const u16 gMetatileAttributes_GhostHouse[] = INCBIN_U16("data/tilesets/secondary/ghost_house/metatile_attributes.bin");
