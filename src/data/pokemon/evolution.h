const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GOLBAT]                = {{EVO_LEVEL, 39, SPECIES_CROBAT}},
    ...
    [SPECIES_MACHOP]                = {{EVO_LEVEL, 22, SPECIES_MACHOKE}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 39, SPECIES_GOLEM}},
    ...
    [SPECIES_SCYTHER]               = {{EVO_LEVEL, 40, SPECIES_SCIZOR}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_ELECTABUZZ]            = {{EVO_TRADE_ITEM, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]                = {{EVO_LEVEL, 40, SPECIES_MAGMORTAR}},
#endif
    ...
    [SPECIES_EEVEE]                 = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                       {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON}
                                       },
    [SPECIES_JOLTEON]              = {{EVO_LEVEL, 44, SPECIES_RAIKOU}},
    [SPECIES_FLAREON]              = {{EVO_LEVEL, 44, SPECIES_ENTEI}},
    [SPECIES_VAPOREON]              = {{EVO_LEVEL, 44, SPECIES_SUICUNE}},
    ...
    [SPECIES_PICHU]                 = {{EVO_LEVEL, 25, SPECIES_PIKACHU}},
    ...
    [SPECIES_MARILL]                = {{EVO_LEVEL, 25, SPECIES_AZUMARILL}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_SNEASEL]               = {{EVO_LEVEL, 38, SPECIES_WEAVILE}},
#endif
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_PORYGON2]              = {{EVO_LEVEL, 40, SPECIES_PORYGON_Z}},
#endif
    ...
    [SPECIES_MIME_JR]               = {{EVO_LEVEL, 23, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_GURDURR]               = {{EVO_LEVEL, 42, SPECIES_CONKELDURR}},
    ...
    [SPECIES_HELIOPTILE]            = {{EVO_LEVEL, 35, SPECIES_HELIOLISK}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_LEVEL, 35, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_LEVEL, 36, SPECIES_GOURGEIST}},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 36, SPECIES_GOLEM_ALOLAN}},
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_LEVEL, 19, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_LEVEL, 19, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_LEVEL, 19, SPECIES_GOURGEIST_SUPER}},
#endif
#if P_GEN_7_POKEMON == TRUE
